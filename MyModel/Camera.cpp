...
bool SingleSoftTrigglerCamera::PrintDeviceInfo()
{
	if (NULL == pDeviceInfo)
	{
...
bool SingleSoftTrigglerCamera::Convert2Mat(cv::Mat & srcImg)
{
	...
	/*****************************/
		...
		*/
		...
		pDataForRGB = (unsigned char*)malloc(pstImageInfo.nWidth * pstImageInfo.nHeight * 3);
		if (NULL == pDataForRGB)
		{
